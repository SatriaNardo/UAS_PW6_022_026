...
<div id="cardd">
        <div id="card-content" >
            ...
            <form method="post" enctype="multipart/form-data" class="form" action="tambahGame.php">
                ...
                <input id="game" class="form-content" type="game" name="game" autocomplete="on"
                    required>
                <div class="form-border"></div>
                <label for="harga" style="padding-top: 13px;">
                    &nbsp;Harga
                </label>
                <input id="harga" class="form-content" type="harga" name="harga" autocomplete="on"
                    required>
                <div class="form-border"></div>
                <label for="link" style="padding-top: 13px;">
                    &nbsp;Link
                </label>
                <input id="link" class="form-content" type="link" name="link" autocomplete="on"
                    required>
                <div class="form-border"></div>
